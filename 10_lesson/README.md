...
2. В отчете Allure вы увидите:
   ...
   # Автотесты для интернет-магазина Sauce Demo

Этот проект содержит автоматизированные тесты для интернет-магазина [Sauce Demo](https://www.saucedemo.com/), написанные с использованием Selenium WebDriver и паттерна Page Object.
